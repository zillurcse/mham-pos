<?php
return [
    "card_payment_model"=>"Please click end card sale",
    "currency"=>"Currency",
    "select.pricgroup"=>"Select Price Group",
    "pricgroup"=>"Price Group",
    "cashier"=>"Cashier",
    "mobile_number_is_not_valid"=>"Mobile number is not valid",
    "date_is_not_valid"=>"Start date and End date is not valid or null",
    ...
    "product_sell_day"=>"Product Sell Report",
    "product_purchas_day"=>"Product Purchases Report",
    "installmented"=>"insatllmented",
