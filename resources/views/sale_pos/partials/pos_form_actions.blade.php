...
@endphp
<div class="row">
	<div class="pos-form-actions" style="background-color: #3c3e4f !important; color: #fff !important;">
		<div class="col-md-12">
	     @if($is_mobile)
			...
			<button type="button" class="btn btn-primary btn-flat @if(!$is_direct_sale) pull-right @endif @if($is_mobile) col-xs-6 @endif" data-toggle="modal" data-target="#recent_transactions_modal" id="recent-transactions"> <i class="fas fa-clock"></i> @lang('lang_v1.recent_transactions')</button>
			@endif
