...
<div class="col-md-12 no-print pos-header">
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="m-6 mt-5" style="display: flex; color: #fff !important;">
    ...
    <div class="col-md-6">
      ...
      @endif
        ...
        <a class="btn btn-primary btn-flat m-6 btn-xs m-5 pull-right" target="_blank" href="{{URL::to('/reports/product-sell-report')}}" >
