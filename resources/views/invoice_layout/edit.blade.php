...
@endif
  ...
  <div class="box box-solid">
    <div class="box-body">
      <div class="row">
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('sub_heading_line1', __('lang_v1.sub_heading_line') . ' 1 :' ) !!}
            {!! Form::text('sub_heading_line1', $invoice_layout->sub_heading_line1, ['class' => 'form-control',]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('sub_heading_line2', __('lang_v1.sub_heading_line') . ' 2 :' ) !!}
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('sub_heading_line3', __('lang_v1.sub_heading_line') . ' 3 :' ) !!}
            {!! Form::text('sub_heading_line3', $invoice_layout->sub_heading_line3, ['class' => 'form-control' ]); !!}
          </div>
        </div>
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('sub_heading_line4', __('lang_v1.sub_heading_line') . ' 4 :' ) !!}
        ...
        <div class="col-sm-4">
          <div class="form-group">
            {!! Form::label('sub_heading_line5', __('lang_v1.sub_heading_line') . ' 5 :' ) !!}
  ...
  <div class="box box-solid">
    ...
    {{--Tax Data Eng Mohamed ali  25-11-2021--}}
    <div  class="box box-solid" >
      <div class="box-body">
        <div class="col-sm-12">
          <div class="form-group">
        ...
        <div class="col-sm-4" style="display: none">
          <div class="form-group">
            {!! Form::label('tax_number', __('lang_v1.tax_number') . ':' ) !!}
            {!! Form::text('tax_number', $invoice_layout->tax_number, ['class' => 'form-control',]); !!}
          </div>
        </div>
        <div class="col-sm-4" style="display: none">
          <div class="form-group">
            {!! Form::label('commercial_register', __('lang_v1.commercial_register') . ':' ) !!}
            {!! Form::text('commercial_register',$invoice_layout->commercial_register, ['class' => 'form-control',
              ]); !!}
          </div>
        </div>
        <div class="col-sm-4"  style="display: none">
          <div class="form-group">
            {!! Form::label('tax_number2', __('lang_v1.tax_number') . ' 2:' ) !!}
            {!! Form::text('tax_number2', $invoice_layout->tax_number2, ['class' => 'form-control' ]); !!}
          </div>
        </div>
...
@component('components.widget', ['class' => 'box-solid', 'title' => __('lang_v1.qr_code')])
  <div class="row">
    ...
    @php
      $qr_code_fields = empty($invoice_layout->qr_code_fields) ? [] : json_decode($invoice_layout->qr_code_fields);
