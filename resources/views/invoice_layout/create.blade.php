    ...
    <div class="box-body">
      ...
      <div class="col-sm-4"  style="display: none">
        <div class="form-group">
          ...
          {!! Form::text('tax_number2', null, ['class' => 'form-control' ]); !!}
        </div>
      </div>
      ...
      <div class="col-sm-3 d-none" style="display: none">
        <div class="form-group">
          <div class="checkbox">
            <label>
              {!! Form::checkbox('show_tax_1', 1, 0, ['class' => 'input-icheck']); !!} @lang('invoice.show_tax_1')</label>
          </div>
        </div>
      </div>
      <div class="col-sm-3 " style="display: none">
        <div class="form-group">
          <div class="checkbox">
            <label>
              {!! Form::checkbox('show_tax_2', 1, 0, ['class' => 'input-icheck']); !!} @lang('invoice.show_tax_2')</label>
          </div>
        </div>
      </div>
    </div>
