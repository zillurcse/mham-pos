    ...
    <div class="row">
        ...
        <span class="input-group-addon">
            <i class="fas fa-money-bill-alt"></i>
                    ...
                    {!! Form::select('currency_id', $currencies, '101', ['class' => 'form-control select2','style'=>'max-width:200px',    'placeholder' => __('business.currency_placeholder'), 'required']); !!}
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-6" style="display: none">
            ...
            <span class="input-group-addon">
                <i class="fa fa-globe"></i>
                    ...
                    {!! Form::text('website', 'https://mhamcloud.com', ['class' => 'form-control','placeholder' => __('lang_v1.website')]); !!}
                </div>
            </div>
        </div>
        <div class="col-md-6">
