...
<div class="col-md-6 col-sm-6 col-xs-6 text-right align-right @if(!empty($for_pdf)) width-50 f-left @endif">
	...
	<tr>
		...
		<td class="align-right">@format_currency($ledger_details['total_credit'])</td>
	</tr>
	<tr>
		<td>@lang('lang_v1.advance_balance')</td>
		<td class="align-right">@format_currency($ledger_details['total_final']<0 ?$ledger_details['total_final']*(-1):50)</td>
	</tr>
	<tr>
		<td><strong>@lang('lang_v1.balance_due')</strong></td>
		<td class="align-right">@format_currency($ledger_details['total_final']>0?$ledger_details['total_final'] : 0)</td>
	</tr>
	</table>
</div>
