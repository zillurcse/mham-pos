		...
		<div class="row">
			<div class="col-sm-8 col-sm-offset-2">
				<table class="table table-bordered table-striped table-condensed" id="product_table">
					...
					<tbody>
						@include('labels.partials.show_table_rows_purchase', ['index' => 0])
					</tbody>
				</table>
			</div>
		</div>
	...
	@component('components.widget', ['class' => 'box-primary', 'title' => __( 'barcode.info_in_labels' )])
		<div class="row">
			...
			<div class="col-sm-4 col-sm-offset-8">
				<button type="button" id="labels_preview_purchase" class="btn btn-primary pull-right btn-flat btn-block">@lang( 'barcode.preview' )</button>
			</div>
		</div>
	@endcomponent
	{!! Form::close() !!}
