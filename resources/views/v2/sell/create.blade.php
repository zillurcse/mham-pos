				...
				@component('components.widget', ['class' => 'box-solid'])
					...
					@if(!empty($price_groups))
						@if(count($price_groups) > 0)
							<div class="col-sm-3">
								{!! Form::label('pay_term_number', __('lang_v1.pricgroup') . ':') !!}
								<div class="form-group">
									<div class="input-group">
									<span class="input-group-addon">
										...
										{!! Form::select('price_group', $price_groups, 0, ['class' => 'form-control select2', 'id' => 'price_group','placeholder'=>__('lang_v1.select.pricgroup')]); !!}
										<span class="input-group-addon">
					...
					@endif
					<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif" style="margin-top: 12px;">
						<div class="form-group">
					...
					@else
						<div class="@if(!empty($commission_agent)) col-sm-3 @else col-sm-4 @endif" style="margin-top: -72px;">
							<div class="form-group">
					...
					@endif
					<div class="col-sm-3" style="margin-top: -72px;">
						<div class="form-group">
						...
						<div class="col-md-4">
			                ...
			                <span class="input-group-addon">
			                    <i class="fa fa-info"></i>
									...
									{!! Form::select('discount_type', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], 'fixed' , ['class' => 'form-control','placeholder' => __('messages.please_select'), 'required', 'data-default' => 'percentage']); !!}
								</div>
							</div>
						</div>
						@php
...
//						@endphp
						...
						<div class="col-md-4">
							...
							<span class="display_currency" id="total_payable">0</span>
							<br>
...
{{--							{!! Form::hidden('advance_balance', null, ['id' => 'advance_balance', 'data-error-msg' => __('lang_v1.required_advance_balance_not_available')]); !!}--}}
							<hr>
							<strong>@lang('lang_v1.balance'):</strong> <span class="balance_due">0.00</span><br><br>
						</div>
						<div class="clearfix"></div>
						...
						<div>
							@if(empty($status) || !in_array($status, ['quotation', 'draft']))
								@can('sell.payments')
									...
									{{--									@component('components.widget', ['id' => "payment_rows_div"])--}}
		...
		<button onclick="myFunction()" type="button" class="btn btn-primary center-block more_btn" >More Information <i class="fa fa-chevron-down"></i></button>
