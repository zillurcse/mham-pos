...
@section('title', __( 'جميع الاقساط'))
@section('content')
@include('sell.installment_nav')
<!-- Content Header (Page header) -->
<section class="content-header no-print">
    <h1>@lang('جميع الاقساط')
    </h1>
</section>
    ...
    @component('components.filters', ['title' => __('report.filters')])
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('sell_list_filter_location_id',  __('حالة الدفع') . ':') !!}

                {!! Form::select('sell_list_filter_stauts', ['due'=>'مستحق','paid'=>'مدفوع'], null, ['id'=>'sell_list_filter_stauts','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all') ]); !!}
            </div>
        </div>
          <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('sell_list_filter_location_id',  __('غرامة ') . ':') !!}

                {!! Form::select('sell_list_filter_fine', ['fine'=>'غرامة','nofine'=>'بدون غرامة'], null, ['id'=>'sell_list_filter_fine','class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' => __('lang_v1.all') ]); !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
        ...
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('sell_list_filter_date_range', __('تاريخ الفاتورة') . ':') !!}
                {!! Form::text('sell_list_filter_date_range', null, ['placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control', 'readonly']); !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('sell_list_filter_date_range', __('.تاريخ الاستحقاق') . ':') !!}
                {!! Form::text('sell_list_due_filter_date_range', null, ['id'=>'sell_list_due_filter_date_range','placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control', 'readonly']); !!}
            </div>
        </div>
        <div class="col-md-3">
            <div class="form-group">
                {!! Form::label('sell_list_filter_date_range', __('.تاريخ السداد') . ':') !!}
                {!! Form::text('sell_list_paid_filter_date_range', null, ['id'=>'sell_list_paid_filter_date_range','placeholder' => __('lang_v1.select_a_date_range'), 'class' => 'form-control', 'readonly']); !!}
            </div>
        </div>
