...
@section('content')
    <style>
        .btn-primary.active,.btn-primary.foucs{
        ...
        <div class="row mb-12">
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="@if(empty($pos_settings['hide_product_suggestion'])) col-md-12 @else col-md-10 col-md-offset-1 @endif no-padding pr-12">
                        <div class="box box-solid mb-12">
                            <div class="box-body pb-0">
                                ...
                                {{-- form for product table pos--}}
                                @include('sale_pos.partials.pos_form')
                                {!! Form::label('sell_note',__('sale.sell_note')) !!}
                                {!! Form::textarea('sale_note_pos', null, ['class' => 'form-control', 'rows' => 2]); !!}
...
{{--                    @endif--}}
        ...
        {{--form acction buttons  and last tarnsaction--}}
