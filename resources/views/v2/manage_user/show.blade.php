...
<section class="content">
    @component('v2.components.widget', ['class' => '', 'title' => __( 'lang_v1.view_user' )])
    <div class="row">
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-3">
            <!-- Profile Image -->
            @component('v2.components.widget', ['class' => '', 'title' => ''])
            <div class="box box-primary">
                <div class="box-body box-profile">
                    ...
                    @can('user.update')
                    <a href="{{action('ManageUserController@edit', [$user->id])}}" class="btn btn-primary btn-block btn-sm mt-10">
        ...
        <div class="col-md-9">
            ...
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a href="#user_info_tab" class="nav-link" data-toggle="tab" aria-expanded="true">
                            <span class="nav-icon"><i class="fas fa-user" aria-hidden="true"></i></span>
                            <span class="nav-text">@lang( 'lang_v1.user_info')</span>

                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="#documents_and_notes_tab" class="nav-link" data-toggle="tab" aria-expanded="true">
                    ...
                    <li class="nav-item">
                        <a href="#activities_tab" class="nav-link" data-toggle="tab" aria-expanded="true">
             ...
             <div class="tab-content mt-10">
                <div class="tab-pane active show fade" id="user_info_tab">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="col-md-6">
