...
<section class="content">
  ...
  <div class="row">
    <div class="col-md-12">
      @component('v2.components.widget',['title'=> __( 'user.add_user' )])
      <div class="row">
   ...
   <div class="col-md-12">
    @component('v2.components.widget', ['title' => __('lang_v1.roles_and_permissions')])
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
          <div class="checkbox">
  ...
  <div class="col-md-12">
    @component('v2.components.widget', ['title' => __('sale.sells')])
    <div class="row">
      <div class="col-md-4">
        <div class="form-group">
...
@include('v2.user.edit_profile_form_part')

@component('v2.components.widget', ['title' => ''])
<div class="row">
