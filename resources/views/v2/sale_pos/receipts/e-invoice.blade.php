    ...
    <tr>
        <td class="text-center" style="line-height: 15px !important; padding-bottom: 10px !important">
            ...
            @if(!empty($receipt_details->logo))
                <img src="{{$receipt_details->logo}}" class="img" style="height: 100px; width: 120px; float: left;">
            @endif
            ...
            @if(!empty($receipt_details->invoice_heading))
                <p class="" style="font-weight: bold; font-size: 25px !important">{!! $receipt_details->invoice_heading !!}</p>
            @endif
        </td>
    </tr>
        ...
        <td>
            ...
            <div class="row invoice-info">
                <div class="col-md-6 invoice-col width-50">
                    <div class="text-right" style="margin-right: -100px; font-size: 18px">
                        @if(!empty($receipt_details->invoice_no_prefix))
                            {!! $receipt_details->invoice_no_prefix !!}
                        @endif
                ...
                <!-- Date-->
                    ...
                    {{--                    @if(!empty($receipt_details->date_label))--}}
                    {{--                        <div class="text-right color-555" style="font-size: 18px !important;">--}}
                ...
                <div class="col-xs-12">
                    ...
                    <table class="table table-bordered table-no-top-cell-border table-slim">
                        ...
                        <tr style="background-color: #357ca5 !important; color: white !important; font-size: 15px !important font-weight: bold;" class="table-no-side-cell-border table-no-top-cell-border text-center">
                            <td style="background-color: #357ca5 !important; color: white !important;" width="5%">#</td>

                            <td style="background-color: #357ca5 !important; color: white !important;" class="text-left" width="55%">
                            ...
                            <td style="background-color: #357ca5 !important; color: white !important;" class="text-right" width="10%">
                                {!! $receipt_details->table_qty_label !!}
                            </td>
                            <td style="background-color: #357ca5 !important; color: white !important;" class="text-right" width="17%">
...
{{--                            @endif--}}
                            ...
                            <td style="background-color: #357ca5 !important; color: white !important;" width="13%" class="text-right">
...
{{--                        @endif--}}
                        ...
                        <tr>
                            <th style="background-color: #357ca5 !important; color: white !important; font-size: 15px !important;" class="padding-10">
                                {!! $receipt_details->total_due_label !!}
                            </th>
                            <td class="text-right padding-10" style="background-color: #357ca5 !important; color: white !important; font-size: 20px;">
                        ...
                        <!-- Total Due-->
{{--                        @if(!empty($receipt_details->total_due))--}}
{{--                            <div class="text-right padding-10" style="background-color: #357ca5 !important; color: white !important; font-size: 20px;">--}}
{{--                                <span class="pull-left bg-light-blue-active">--}}
{{--                                    {!! $receipt_details->total_due_label !!}--}}
{{--                                </span>--}}
{{--                                {{$receipt_details->total_due}}--}}
...
{{--                        @endif--}}
            ...
            <div style="display: flex; float: right;">
                <div>
                    @if(!empty($receipt_details->total_paid))
                        <div class="text-right color-555" style="border: 2px solid !important; padding: 8px; margin-top: 15px; font-size: 15px !important;">
                            <span class="pull-left">{!! $receipt_details->total_paid_label !!}</span>
                            {{$receipt_details->total_paid}}
                        </div>
                    @endif
                ...
                <div>
                    <div class="text-right color-555" style="border: 2px solid !important; padding: 8px; margin-top: 15px; font-size: 15px !important;">
                        <span class="pull-left">{!! $receipt_details->total_label !!}</span>
                        {{$receipt_details->total}}
                        @if(!empty($receipt_details->total_in_words))
                            <br>
                            <small>({{$receipt_details->total_in_words}})</small>
