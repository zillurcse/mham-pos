...
<div class="content" style="background: white;">
    ...
    <form action="{{action('BusinessController@store_gov')}}" method="POST" class="row">
            @csrf
                ...
                <div class="table-responsive">
                    <table class="table table-striped" >
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$row->name}}</td>
                                <td><a class="btn btn-danger" href="/business/delete_gov/{{$row->id}}" ><i class="fa fa-trash"></i></a></td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
