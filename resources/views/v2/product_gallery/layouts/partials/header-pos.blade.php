  ...
  <div class="row">
    ...
    <div class="col-md-6">
      ...
      @endif
        ...
        <a class="btn btn-primary btn-flat m-6 btn-xs m-5 pull-right" target="_blank" href="{{URL::to('/sell-returns/getinv')}}" >
            <strong>مرتجع المبيعات</strong>
        </a>
        @endcan
  <?php if (auth()->user()->can('sales.show_purchase_price_in_pos') ) {?>
