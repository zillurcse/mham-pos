...
@section('content')
    ...
    <section class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">@lang('product.add_new_product')</h1>
        <!-- <ol class="breadcrumb">
    ...
    <div class="flex-row-fluid py-lg-5 px-lg-15">
        ...
        {!! Form::open(['url' => action('ProductController@store'), 'method' => 'post',
            'id' => 'product_add_form','class' => 'product_form form' . $form_class, 'files' => true ]) !!}
        @component('v2.components.widget', ['class' => 'pt-5'])
            <div class="row pt-0 d-flex gap-0">
                <div class="col-sm-12 mb-10 fv-row mb-10 fv-row">
                    <div class="form-group">
                        {!! Form::label('name', __('product.product_name') . ':*','class="form-label"') !!}
                ...
                <div class="col-sm-4 mb-10 fv-row">
                    <div class="form-group">
                        {!! Form::label('sku', __('product.sku') . ':','class="form-label"') !!} @show_tooltip(__('tooltip.sku'))
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('sku2', __('product.sku2') . ':','class="form-label"') !!}
                ...
                <div class="col-sm-4 mb-10 fv-row">
                    <div class="form-group">
                        {!! Form::label('barcode_type', __('product.barcode_type') . ':*','class="form-label"') !!}
                        {!! Form::select('barcode_type', $barcode_types, !empty($duplicate_product->barcode_type) ? $duplicate_product->barcode_type : $barcode_default, ['class' => 'form-select mb-2', 'required']); !!}
                    </div>
                </div>
                ...
                <div class="col-sm-4 mb-10 fv-row">
                    <div class="form-group">
                        {!! Form::label('unit_id', __('product.unit') . ':*','class="form-label"') !!}
                ...
                <div class="col-sm-4 mb-10 fv-row @if(!session('business.enable_sub_units')) hide @endif">
                    <div class="form-group">
                        {!! Form::label('sub_unit_ids', __('lang_v1.related_sub_units') . ':','class="form-label"') !!} @show_tooltip(__('lang_v1.sub_units_tooltip'))
                ...
                <div class="col-sm-4 mb-10 fv-row @if(!session('business.enable_brand')) hide @endif">
                    <div class="form-group">
                        {!! Form::label('brand_id', __('product.brand') . ':','class="form-label"') !!}
                        <div class="input-group">
                ...
                <div class="col-sm-4 mb-10 fv-row @if(!session('business.enable_category')) hide @endif">
                    <div class="form-group">
                ...
                <div class="col-sm-4 mb-10 fv-row @if(!(session('business.enable_category') && session('business.enable_sub_category'))) hide @endif">
                    <div class="form-group">
                ...
                <div class="col-sm-4 mb-10 fv-row">
                    <div class="form-group">
                        {!! Form::label('product_locations', __('business.business_locations') . ':','class="form-label"') !!} @show_tooltip(__('lang_v1.product_location_help'))
                ...
                <div class="col-sm-4 mb-10 fv-row">
                    <div class="fv-row">
                        ...
                        <div class="form-check form-check-custom form-check-solid mb-2">
                            {!! Form::checkbox('enable_stock', 1, !empty($duplicate_product) ? $duplicate_product->enable_stock : true, ['class' => 'form-check-input', 'id' => 'enable_stock']); !!}
                            <label class="form-check-label">@lang('product.manage_stock')</label>
                        </div>
                        @show_tooltip(__('tooltip.enable_stock')) <i data-bs-toggle="tooltip" data-bs-placement="top" title="{!! __('tooltip.enable_stock') !!}">@lang('product.enable_stock_help')</i>
                    </div>
                </div>
                <div class="col-sm-4 mb-10 fv-row @if(!empty($duplicate_product) && $duplicate_product->enable_stock == 0) hide @endif" id="alert_quantity_div">
                    <div class="form-group">
                        {!! Form::label('alert_quantity',  __('product.alert_quantity') . ':','class="form-label"') !!} @show_tooltip(__('tooltip.alert_quantity'))
                ...
                @if(!empty($common_settings['enable_product_warranty']))
                    <div class="col-sm-4 mb-10 fv-row">
                        <div class="form-group">
                            {!! Form::label('warranty_id', __('lang_v1.warranty') . ':','class="form-label"') !!}
                ...
                <div class="col-sm-8">
                    <div class="form-group">
                        {!! Form::label('product_description', __('lang_v1.product_description') . ':','class="form-label"') !!}
                ...
                <div class="col-sm-4 mb-10 fv-row">
                    <div class="form-group">
                        {!! Form::label('image', __('lang_v1.product_image') . ':','class="form-label"') !!}
            ...
            <div class="col-sm-4 mb-10 fv-row">
                <div class="form-group">
                    {!! Form::label('product_brochure', __('lang_v1.product_brochure') . ':','class="form-label"') !!}
            ...
            <div class="row">
                @if(session('business.enable_product_expiry'))
                    ...
                    @else
                        ...
                        @endphp
                    @endif
                    <div class="col-sm-4 mb-10 fv-row @if($hide) hide @endif">
                        <div class="form-group">
                            <div class="multi-input">
                                {!! Form::label('expiry_period', __('product.expires_in') . ':','class="form-label"') !!}<br>
                ...
                @if(session('business.enable_racks') || session('business.enable_row') || session('business.enable_position'))
                    ...
                    @foreach($business_locations as $id => $location)
                        <div class="col-sm-3">
                            <div class="form-group">
                                {!! Form::label('rack_' . $id,  $location . ':','class="form-label"') !!}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('product_custom_field1',  $product_custom_field1 . ':','class="form-label"') !!}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('product_custom_field2',  $product_custom_field2 . ':','class="form-label"') !!}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('product_custom_field3',  $product_custom_field3 . ':','class="form-label"') !!}
                ...
                <div class="col-sm-3">
                    <div class="form-group">
                        {!! Form::label('product_custom_field4',  $product_custom_field4 . ':','class="form-label"') !!}
        ...
        @component('components.widget', ['class' => 'box-primary'])
            <div class="row">
                ...
                <div class="col-sm-4 mb-10 fv-row @if(!session('business.enable_price_tax')) hide @endif">
                    <div class="form-group">
                        {!! Form::label('tax', __('product.applicable_tax') . ':','class="form-label"') !!}
                ...
                <div class="col-sm-4 mb-10 fv-row  hide ">
                    <div class="form-group">
                        {!! Form::label('tax_type', __('product.selling_price_tax_type') . ':*','class="form-label"') !!}
                ...
                <div class="col-sm-4 mb-10 fv-row">
                    <div class="form-group">
                        {!! Form::label('type', __('product.product_type') . ':*','class="form-label"') !!} @show_tooltip(__('tooltip.product_type'))
