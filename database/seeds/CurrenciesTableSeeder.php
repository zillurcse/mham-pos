...
class CurrenciesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            ...
            "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null,"status"=>1 ],
            ...
            "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null ],
            [ "id" => "35", "country" => "Egypt", "currency" => "Pounds", "code" => "EGP", "symbol" => "جنيها",
            "thousand_separator" => ",", "decimal_separator" => ".", "created_at" => null , "updated_at" => null,"status"=>0 ],
