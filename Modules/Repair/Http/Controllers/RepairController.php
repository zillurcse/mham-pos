...
class RepairController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('repair::'.viewSource().'repair.index')->with(compact('business_locations', 'customers', 'service_staffs', 'repair_status_dropdown', 'sales_representative', 'is_service_staff'));
    }
    ...
    public function create()
    {
        ...
        return view('repair::'.viewSource().'repair.create')
                ->with(compact(
                    'business_details',
                    'taxes',
                    'walk_in_customer',
    ...
    public function show($id)
    {
        ...
        return view('repair::'.viewSource().'repair.show')
    ...
    public function edit($id)
    {
        ...
        return view('repair::'.viewSource().'repair.edit')
            ->with(compact(
                'business_details',
                'taxes',
                'sell_details',
    ...
    public function editRepairStatus($repair_id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('repair::'.viewSource().'repair.partials.edit_repair_status_modal')
    ...
    public function printLabel($transaction_id)
    {
        try {
            ...
            return view('repair::'.viewSource().'repair.partials.preview_label')
