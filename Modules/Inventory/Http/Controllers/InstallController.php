...
class InstallController extends Controller
{
    ...
    public function install()
    {
      // try {
        ...
        Artisan::call('module:migrate-reset', ['module' => "inventory"]); // delete tabels that in migration used by module
        Artisan::call('module:migrate', ['module' => "inventory"]);       // add tables that in migartion
    ...
    public function update()
    {
        ...
        try {
            ...
            if (Comparator::greaterThan($this->appVersion, $superhero_version)) {
                ...
                DB::statement('SET default_storage_engine=INNODB;');
                Artisan::call('module:migrate', ['module' => "inventory"]);
