...
class ContactLoginController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $input = $request->only('crm_contact_id', 'surname', 'first_name', 'last_name', 'email', 'username', 'password', 'contact_number', 'alt_number', 'family_number');
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $input = $request->only('surname', 'first_name', 'last_name', 'email', 'username', 'contact_number', 'alt_number', 'family_number');
