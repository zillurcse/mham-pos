...
class PayrollController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('essentials::'.viewSource().'payroll.index')->with(compact('employees', 'is_admin', 'departments', 'designations'));
    }
    ...
    public function create()
    {
        ...
        if (empty($payroll)) {
            ...
            return view('essentials::'.viewSource().'payroll.create')
    ...
    public function show($id)
    {
        ...
        return view('essentials::'.viewSource().'payroll.show')->with(compact('payroll', 'month_name', 'allowances', 'deductions', 'year', 'payment_types'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('essentials::'.viewSource().'payroll.edit')->with(compact('payroll', 'month_name', 'allowances', 'deductions', 'year'));
    }
