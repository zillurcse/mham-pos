    ...
    */
    public function moduleViewPartials($data)
    {
        if ($data['view'] == 'manage_user.create' || $data['view'] == 'manage_user.edit') {
            ...
            return view('essentials::'.viewSource().'partials.user_form_part', compact('departments', 'designations', 'user'))->render();
            ...
            return view('essentials::'.viewSource().'partials.user_details_part', compact('user_department', 'user_designstion'))->render();
        }
    }
