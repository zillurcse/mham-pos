...
class EssentialsLeaveController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('essentials::'.viewSource().'leave.index')->with(compact('leave_statuses', 'users', 'leave_types', 'is_admin'));
    }
    ...
    public function create()
    {
        ...
        return view('essentials::'.viewSource().'leave.create')->with(compact('leave_types', 'instructions', 'employees'));
    }
    ...
    public function activity($id)
    {
        ...
        return view('essentials::'.viewSource().'leave.activity_modal')->with(compact('leave', 'activities'));
    }
    ...
    public function getUserLeaveSummary()
    {
        ...
        return view('essentials::'.viewSource().'leave.user_leave_summary')->with(compact('leaves_summary', 'leave_types', 'statuses', 'user', 'status_summary'));
    }
}
