<div class="modal-dialog" role="document">
    <div class="modal-content">
        ...
        {!! Form::open(['url' => action('\Modules\Assets\Http\Controllers\PaymentsController@update',$data->id), 'method' => 'PUT' ]) !!}
        ...
        <div class="modal-body">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    {!! Form::text('date', $data->date, ['class' => 'form-control date-picker','required','placeholder' => __('Assets.purchasedate'), 'readonly']); !!}
                </div>
            </div>
