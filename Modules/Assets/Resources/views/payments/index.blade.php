                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                                ...
                                {!! Form::select('partner_id', $Assets, null, ['class' => 'form-control select2', 'style' => 'width:100%', 'placeholder' =>'الكل']); !!}
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2 col-md-3">
                            <div class="form-group">
                               ...
                               {!! Form::text('startdate', null, ['class' => 'form-control start-date-picker','placeholder' => __('Assets.purchasedate'), 'readonly']); !!}
                                </div>
                            </div>
                        </div>
