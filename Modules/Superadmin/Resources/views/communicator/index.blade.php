			...
			<div class="box">
		        ...
		        <div class="box-body">
		        	{!! Form::open(['url' => action('\Modules\Superadmin\Http\Controllers\CommunicatorController@send'), 'method' => 'post', 'id' => 'communication_form']) !!}
						...
						<div class="col-md-12 form-group">
							@php
							$select_type = array('Email','SMS');
							@endphp
							{!! Form::label('select_type', __('superadmin::lang.select_type') . ':*') !!}
							{!! Form::select('select_type[]', $select_type, null, ['class' => 'form-control select2', 'required', 'multiple', 'id' => 'select_type']); !!}
		        		</div>
		        		<div class="col-md-12 form-group">
