<li class="bg-maroon treeview {{ in_array($request->segment(1), ['project']) ? 'active active-sub' : '' }}" style="background:#f0d559d9">
	<a href="#">
    ...
    <ul class="treeview-menu">
    	<li class="{{ $request->segment(2) == 'project' ? 'active active-sub' : '' }}"  style="background:#f0d559d9">
