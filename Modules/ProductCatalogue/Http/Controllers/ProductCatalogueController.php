...
class ProductCatalogueController extends Controller
{
    ...
    public function index($business_id, $location_id)
    {
        ...
        return view('productcatalogue::'.viewSource().'catalogue.index')->with(compact('products', 'business', 'discounts', 'business_location', 'categories'));
    }
    ...
    public function show($business_id, $id)
    {
        ...
        return view('productcatalogue::'.viewSource().'catalogue.show')->with(compact(
            'product',
            'allowed_group_prices',
            'group_price_details',
            'combo_variations',
    ...
    public function generateQr()
    {
        ...
        return view('productcatalogue::'.viewSource().'catalogue.generate_qr')
