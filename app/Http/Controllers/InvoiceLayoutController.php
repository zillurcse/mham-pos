...
class InvoiceLayoutController extends Controller
{
    ...
    public function create()
    {
        ...
        // to use edit as create eng ali 27-11-2021
        $invoice_layout =new InvoiceLayout();
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            /* Used for error : Array to string conversion*/
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $input = $request->only(['name', 'header_text',
                    ...
                    ,'tax_number','tax_number2','commercial_register'
                           ]);
            $business_id = $request->session()->get('user.business_id');
