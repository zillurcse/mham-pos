        ...
        try {
            ...
            foreach ($product_details_page_wise as $page => $page_products) {
             ...
             //dd($request->barcode);
                ...
                if($request->code_type=='parcode'){
                                $output = view('labels.partials.preview_2')
                                            ->with(compact('print', 'page_products','barcodes', 'business_name', 'barcode_details', 'margin_top', 'margin_left', 'paper_width', 'paper_height', 'is_first', 'is_last', 'factor'))->render();
                }else{
                                $output = view('labels.partials.qrcode')
               ...
               /* $output = view('labels.partials.preview_2_purchase')
                    ->with(compact('print', 'page_products', 'business_name', 'barcode_details', 'margin_top', 'margin_left', 'paper_width', 'paper_height', 'is_first', 'is_last', 'factor'))->render();
                */
