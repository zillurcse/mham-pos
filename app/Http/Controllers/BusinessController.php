...
use App\Business;
use App\Currency;
use App\Mail\NewBusinessEmailNotification;
...
//            dd();
            ...
            // dd($business_details['start_date']);
...
//            $business_details['enabled_modules'] =["purchases","add_sale","pos_sale","stock_transfers","stock_adjustment","expenses","account","tables","modifiers","service_staff","booking","kitchen","subscription","types_of_service"];
            $business_details['enabled_modules'] =["purchases","add_sale","pos_sale","stock_transfers","stock_adjustment","expenses","account","modifiers"];
// dd($business_details);
            ...
            if ($business_location['mobile'] != null) {
                $toNum = $business_location['mobile'];
//                $body = "Successfully registered! ({$business->name}) your user name : {$user->username} password  :  {$request->password} You can enter  mhamcloud the link https://mhamcloud.com";
                $body = "تم تسجيل الحساب بنجاح ! user name: {$user->username} password: {$request->password} يمكن الدخول عبر https://mhamcloud.com ";
                $sms = $this->SendSMS($toNum, $body);
                if ($sms == true) {
...
//    {
//        $toNum = '0505263775';
//        $body = "Successfully registered Zillur SHOP
//                        user name : zillurcse
//                        password  : zillurcse123
//                        You can enter  mhamcloud the link
//                        https://mhamcloud.com";
//        $this->SendSMS($toNum, $body);
//    }
