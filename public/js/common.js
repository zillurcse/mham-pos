...
var dateRangeSettings = {
    /* menu that select from */
    ranges: ranges,
    /*default sart date if not found us current this day*/
...
/*currency button add by eng\ali*/
$('button#btncurrency').hover(function() {
    $(this).tooltip('show');
});
$(document).on('mouseleave', 'button#btncurrency', function(e) {
    $(this).tooltip('hide');
});
