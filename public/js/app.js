...
$(document).on('click', 'button#btncurrency', function () {
     $.ajax({
        method: 'GET',
        url: '/changecurrency',
        dataType: 'html',
        success: function (result) {
            $(".divcurrency").html(result).modal('show');
...
//save currency submit
$(document).on('submit', 'form#savecurrency', function(e) {
    e.preventDefault();
    var form = $(this);
    var data = form.serialize();
